...
class ContentSummarizer:
    ...
    async def summarize_content(self, content: str, title: str = "", 
                              summary_type: str = "executive") -> Dict:
        """
    ...
    async def _direct_summarization(self, content: str, title: str, 
                                  summary_type: str) -> Dict:
    ...
    async def _chunked_summarization(self, content: str, title: str, 
                                   summary_type: str) -> Dict:
    ...
    async def _summarize_with_openai(self, content: str, title: str, 
                                   summary_type: str) -> Dict:
    ...
    async def _summarize_with_anthropic(self, content: str, title: str, 
                                      summary_type: str) -> Dict:
    ...
    async def _extractive_summarization(self, content: str, title: str) -> Dict:
        ...
        try:
            ...
            scored_sentences = [(score, i, sent) for i, (score, sent) 
                              in enumerate(zip(sentence_scores, sentences))]
