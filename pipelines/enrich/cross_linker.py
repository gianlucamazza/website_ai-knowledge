...
class CrossLinker:
    ...
    async def find_related_articles(self, article_id: str, session: AsyncSession,
    ...
    def _find_link_contexts(self, content: str, target_title: str, 
    ...
    def _calculate_context_relevance(self, context: str, term: str, 
                                   target_categories: List[str]) -> float:
        ...
        technical_indicators = [
            ...
            'model', 'system', 'implementation', 'architecture'
        ]
