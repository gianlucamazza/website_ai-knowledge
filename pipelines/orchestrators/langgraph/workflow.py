...
class PipelineWorkflow:
    ...
    def _add_workflow_edges(self, workflow: StateGraph) -> None:
        ...
        workflow.add_conditional_edges(
            ...
            {"normalize": "normalize", "error": "handle_error", "complete": "finalize"},
        )

        workflow.add_conditional_edges(
            "normalize",
            self._route_after_normalize,
            {"dedup": "dedup", "error": "handle_error", "review": "human_review_check"},
        )
        ...
        workflow.add_conditional_edges(
            ...
            {"retry": "retry_check", "skip": "finalize", "abort": END},
        )
