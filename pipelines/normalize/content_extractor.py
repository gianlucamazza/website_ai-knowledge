...
class ContentExtractor:
    ...
    def _extract_metadata(self, html_content: str, url: str) -> Dict:
        ...
        author = (
            ...
            soup.find('span', attrs={'rel': 'author'})
        )
        if author:
            if author.name == 'meta':
    ...
    def _calculate_quality_score(self, content: str, word_count: int, 
    ...
    def _calculate_readability_score(self, content: str, word_count: int, 
